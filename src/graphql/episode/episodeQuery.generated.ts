...
export type UpdateTodayEpisodeMutation = {
...
export type GetTodayEpisodesQuery = {
...
export type GetEpisodeQuery = {
  ...
  episodes_by_pk?: {
    ...
    has_next_episode: boolean;
    has_prev_episode: boolean;
    next_episode_id?: any | null;
    prev_episode_id?: any | null;
    work: {
      __typename?: "works";
      series_title: string;
      title: string;
...
>(
  ...
  options?: UseMutationOptions<
    ...
    TError,
    UpdateTodayEpisodeMutationVariables,
    TContext
  >,
  ...
  >(
    ["UpdateTodayEpisode"],
    (variables?: UpdateTodayEpisodeMutationVariables) =>
      fetcher<UpdateTodayEpisodeMutation, UpdateTodayEpisodeMutationVariables>(
        client,
        UpdateTodayEpisodeDocument,
        variables,
        headers
      )(),
    options
  );
useUpdateTodayEpisodeMutation.fetcher = (
  client: GraphQLClient,
  variables: UpdateTodayEpisodeMutationVariables,
  headers?: RequestInit["headers"]
) =>
...
>(
  ...
  useQuery<GetTodayEpisodesQuery, TError, TData>(
    ...
    fetcher<GetTodayEpisodesQuery, GetTodayEpisodesQueryVariables>(
      client,
      GetTodayEpisodesDocument,
      variables,
      headers
    ),
    options
...
useGetTodayEpisodesQuery.getKey = (
  variables: GetTodayEpisodesQueryVariables
) => ["GetTodayEpisodes", variables];
useGetTodayEpisodesQuery.fetcher = (
  client: GraphQLClient,
  variables: GetTodayEpisodesQueryVariables,
  headers?: RequestInit["headers"]
) =>
...
export const useGetEpisodeQuery = <TData = GetEpisodeQuery, TError = unknown>(
  ...
  useQuery<GetEpisodeQuery, TError, TData>(
    ...
    fetcher<GetEpisodeQuery, GetEpisodeQueryVariables>(
      client,
      GetEpisodeDocument,
      variables,
      headers
...
useGetEpisodeQuery.getKey = (variables: GetEpisodeQueryVariables) => [
  "GetEpisode",
  variables,
];
useGetEpisodeQuery.fetcher = (
  client: GraphQLClient,
  variables: GetEpisodeQueryVariables,
  headers?: RequestInit["headers"]
) =>
