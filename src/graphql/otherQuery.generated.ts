...
export type GetMediaTypesQuery = {
  __typename?: "query_root";
  media_types: Array<{ __typename?: "media_types"; id: number; name: string }>;
};
...
>(
  ...
  useQuery<GetMediaTypesQuery, TError, TData>(
    ...
    fetcher<GetMediaTypesQuery, GetMediaTypesQueryVariables>(
      client,
      GetMediaTypesDocument,
      variables,
      headers
    ),
    options
...
useGetMediaTypesQuery.getKey = (variables?: GetMediaTypesQueryVariables) =>
  variables === undefined ? ["GetMediaTypes"] : ["GetMediaTypes", variables];
useGetMediaTypesQuery.fetcher = (
  client: GraphQLClient,
  variables?: GetMediaTypesQueryVariables,
  headers?: RequestInit["headers"]
) =>
