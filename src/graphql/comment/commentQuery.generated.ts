...
export type SubscriptionChatCommentsSubscription = {
...
export type GetChatCommentsQuery = {
  ...
  chat_comments_by_episode_id: Array<{
    __typename?: "chat_comments";
    content: string;
    work_id?: number | null;
    user_id: string;
...
>(
  ...
  options?: UseMutationOptions<
    InsertChatCommentMutation,
    TError,
    InsertChatCommentMutationVariables,
    TContext
  >,
  ...
  >(
    ["InsertChatComment"],
    (variables?: InsertChatCommentMutationVariables) =>
      fetcher<InsertChatCommentMutation, InsertChatCommentMutationVariables>(
        client,
        InsertChatCommentDocument,
        variables,
        headers
      )(),
    options
  );
useInsertChatCommentMutation.fetcher = (
  client: GraphQLClient,
  variables: InsertChatCommentMutationVariables,
  headers?: RequestInit["headers"]
) =>
...
>(
  ...
  useQuery<GetChatCommentsQuery, TError, TData>(
    ...
    fetcher<GetChatCommentsQuery, GetChatCommentsQueryVariables>(
      client,
      GetChatCommentsDocument,
      variables,
      headers
    ),
    options
...
useGetChatCommentsQuery.getKey = (variables: GetChatCommentsQueryVariables) => [
  "GetChatComments",
  variables,
];
useGetChatCommentsQuery.fetcher = (
  client: GraphQLClient,
  variables: GetChatCommentsQueryVariables,
  headers?: RequestInit["headers"]
) =>
