...
export const Panel: FC<Props> = ({ character }) => (
  <div className="relative flex h-[46px] w-[40px] flex-col items-center justify-center rounded-xl bg-white text-2xl text-[#f8f5f5] shadow-[0_3px_4px_0_rgba(0,0,0,.2),inset_2px_4px_0_0_rgba(255,255,255,.08)] md:h-[55px] md:w-[50px] md:text-3xl">
