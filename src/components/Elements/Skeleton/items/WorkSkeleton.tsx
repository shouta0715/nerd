...
export const WorkSkeleton: FC<Props> = ({
  ...
  <div
    className=" grid w-full  grid-cols-2  rounded-2xl  border border-solid border-slate-200 p-3  shadow-lg ring-1 ring-gray-900/5 md:grid-cols-3 md:p-4 lg:grid-cols-4"
    role="status"
  >
