      ...
      >
        ...
        <div className="relative flex flex-1 items-center">
          <TextArea
            ...
            aria-label="コメントを入力"
            className={clsx(
              "flex-1 resize-none appearance-none rounded-md border border-gray-300 px-4 py-2 pr-11 placeholder:pt-1 placeholder:text-xs focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 disabled:border-red-500 disabled:bg-white disabled:opacity-50  disabled:ring-red-500 lg:mr-4 lg:pr-4"
            )}
