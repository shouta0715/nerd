  ...
  <div className="flex w-full">
    <div className="flex min-h-screen max-w-full flex-1 flex-col">
      ...
      <div className="flex flex-1 flex-col md:flex-row">
        <aside className="top-0 max-h-screen  overflow-y-auto border-b border-slate-200 bg-white pb-2 md:sticky md:w-1/3 md:max-w-sm md:border-b-0 md:border-r md:py-4">
