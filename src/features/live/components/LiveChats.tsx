  ...
  return (
    <>
      ...
      <div className="sticky bottom-20 flex w-full justify-between px-2 lg:px-3">
        ...
        <div className="grid h-10 w-10 place-items-center  rounded-full bg-red-600 shadow-md shadow-red-400 transition-transform active:translate-y-1 lg:right-14">
          {isRefetching ? (
