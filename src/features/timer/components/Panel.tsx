...
export const Panel: FC<Props> = ({ character }) => (
  <div className="relative flex h-[40px] w-[36px] flex-col items-center justify-center rounded-xl bg-white font-futura text-base text-[#f8f5f5] shadow-[0_3px_4px_0_rgba(0,0,0,.2),inset_2px_4px_0_0_rgba(255,255,255,.08)] md:h-[46px]  md:w-[40px] md:text-xl ">
